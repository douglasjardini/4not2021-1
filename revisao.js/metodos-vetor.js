...
// find(): retorna a primeira ocorrencia que corresponda ao critério infornado
...
console.log(pets.some(pet => pet.especie === 'tartaruta' && pet.sexo === 'F'))
...
// filter(): retorna uma novo vetor contendo apenas os elementos que
...
// valor atual: o resultado correspondente ao elemenot atual, que
...
// 2º parâmetro do reducd(): valor inicial do acumulador
console.log(pets.reduce((acum, val) => acum + val.peso, 0))

console.log('--------------------')

// includes(): return true caso o vetor inclua o valor informado
...
// includes() -> recebe um valor simples (primitivo) para testar a exixtencia
